-- Update document processing function to handle processing options
...
-- Add comment
COMMENT ON FUNCTION public.enqueue_document_processing IS 'Enqueues a document for processing and adds it to the document_processing_queue. Accepts processing_options for customization. Returns the UUID of the document.'; 